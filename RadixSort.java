...
public class RadixSort {
  ...
  /**
   * Finds the largest number in the array to determine how many digits we need to process
   ...
   * @param digitPosition Which digit position we're currently sorting (1s, 10s, 100s, etc.)
   */
